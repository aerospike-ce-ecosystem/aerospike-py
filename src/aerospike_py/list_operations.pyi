...
def list_insert_items(bin: str, index: int, values: list, policy: Optional[dict] = None) -> dict: ...
...
def list_get_by_index_range(bin: str, index: int, return_type: int, count: Optional[int] = None) -> dict: ...
def list_get_by_rank(bin: str, rank: int, return_type: int) -> dict: ...
def list_get_by_rank_range(bin: str, rank: int, return_type: int, count: Optional[int] = None) -> dict: ...
...
def list_remove_by_value_range(bin: str, begin: Any, end: Any, return_type: int) -> dict: ...
def list_remove_by_index(bin: str, index: int, return_type: int) -> dict: ...
def list_remove_by_index_range(bin: str, index: int, return_type: int, count: Optional[int] = None) -> dict: ...
def list_remove_by_rank(bin: str, rank: int, return_type: int) -> dict: ...
def list_remove_by_rank_range(bin: str, rank: int, return_type: int, count: Optional[int] = None) -> dict: ...
def list_increment(bin: str, index: int, val: int, policy: Optional[dict] = None) -> dict: ...
